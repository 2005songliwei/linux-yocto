				   ...
				   struct snd_soc_dai *dai)
{
	...
	dev_dbg(dai->dev, "Playback Active %d", dai->stream_active[SNDRV_PCM_STREAM_CAPTURE]);
	dev_dbg(dai->dev, "Capture Active  %d", dai->stream_active[SNDRV_PCM_STREAM_PLAYBACK]);
